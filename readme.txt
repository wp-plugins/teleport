...
1. That's it! There aren't any options yet.

== Frequently Asked Questions ==

= How do I use Teleport? =

You can read the instructions on the [Description tab](http://wordpress.org/extend/plugins/teleport/).
...
1. Teleporter - Logged In
2. Teleporter - Logged Out
3. Diagram of the keyboard shortcuts
...
= 1.2.2 =
This update adds title tags to the Teleport buttons. If you forget which button does what, you can now hover over the button to see it's function.
